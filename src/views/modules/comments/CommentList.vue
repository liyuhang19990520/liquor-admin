<template>
  <div>
    <el-form ref="searchForm" :model="searchForm" label-width="80px">
      <el-row>
        <el-col :span="6">
          <el-form-item label="评论内容(模糊)" label-width="110px" prop="cont">
            <el-input
        ...
        <el-col :span="8">
          <el-form-item label="评论时间" label-width="70px" prop="time">
            <el-date-picker
      ...
      <el-table-column fixed="right" label="操作" align="center">
        <template slot-scope="scope">
          <el-button
            type="text"
            size="small"
            @click="$refs['commentForm'].init('view', scope.row._id)"
            >查看</el-button
          >
    ...
    requestList() {
      ...
      this.$http({
        ...
        if (data && data.success) {
          this.commentDataList = data.page.list;
